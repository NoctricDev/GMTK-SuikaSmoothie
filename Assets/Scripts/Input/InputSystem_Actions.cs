...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""BowlScene"",
            ""id"": ""cc3f9d3c-5ea9-4a02-a13f-7d2e4c33c12e"",
            ""actions"": [
                {
                    ""name"": ""MoveCamera"",
                    ""type"": ""Value"",
                    ""id"": ""702c3a9a-9d0f-446b-a2cf-c3c0c8a2ac7b"",
            ...
            ""bindings"": [
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""eba29780-f169-46b8-8133-55f47cfa3248"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""1dfc3f17-c65f-4fbf-a3ff-f85685e83a08"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""322d9fc8-1a6e-445a-a873-3928e9227dbb"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6dcf0267-a903-4d9b-a650-701f322f9864"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
        ...
        {
            ""name"": ""Cheats"",
            ""id"": ""6e3c71f1-f633-4a49-85b5-629e05d4011a"",
            ""actions"": [
                {
                    ""name"": ""OpenConsole"",
                    ""type"": ""Button"",
                    ""id"": ""95703584-c78b-4ce6-a3be-7cf59a47b8c1"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ExecuteCommand"",
                    ""type"": ""Button"",
                    ""id"": ""e0c3b358-fb29-4b28-9ab5-053aa7bf086e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""7867c7a4-c475-41c3-8835-c026090621cd"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e7690122-556d-4760-83a8-ca31cbadedb8"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    /// </summary>
    public struct BowlSceneActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BowlSceneActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "BowlScene/MoveCamera".
        /// </summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_BowlScene; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="BowlSceneActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(BowlSceneActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="BowlSceneActions" />
        public void AddCallbacks(IBowlSceneActions instance)
        {
            if (instance == null || m_Wrapper.m_BowlSceneActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BowlSceneActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="BowlSceneActions" />
        private void UnregisterCallbacks(IBowlSceneActions instance)
        {
            @MoveCamera.started -= instance.OnMoveCamera;
            @MoveCamera.performed -= instance.OnMoveCamera;
            @MoveCamera.canceled -= instance.OnMoveCamera;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="BowlSceneActions.UnregisterCallbacks(IBowlSceneActions)" />.
        /// </summary>
        /// <seealso cref="BowlSceneActions.UnregisterCallbacks(IBowlSceneActions)" />
        public void RemoveCallbacks(IBowlSceneActions instance)
        {
            if (m_Wrapper.m_BowlSceneActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="BowlSceneActions.AddCallbacks(IBowlSceneActions)" />
        /// <seealso cref="BowlSceneActions.RemoveCallbacks(IBowlSceneActions)" />
        /// <seealso cref="BowlSceneActions.UnregisterCallbacks(IBowlSceneActions)" />
        public void SetCallbacks(IBowlSceneActions instance)
        {
            foreach (var item in m_Wrapper.m_BowlSceneActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BowlSceneActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="BowlSceneActions" /> instance referencing this action map.
    /// </summary>
    public BowlSceneActions @BowlScene => new BowlSceneActions(this);

    // Cheats
    private readonly InputActionMap m_Cheats;
    private List<ICheatsActions> m_CheatsActionsCallbackInterfaces = new List<ICheatsActions>();
    private readonly InputAction m_Cheats_OpenConsole;
    ...
    public struct CheatsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Cheats/OpenConsole".
        /// </summary>
        public InputAction @OpenConsole => m_Wrapper.m_Cheats_OpenConsole;
        /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "BowlScene" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BowlSceneActions.AddCallbacks(IBowlSceneActions)" />
    /// <seealso cref="BowlSceneActions.RemoveCallbacks(IBowlSceneActions)" />
    public interface IBowlSceneActions
    {
        /// <summary>
